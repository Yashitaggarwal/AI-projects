...
3. Provides accommodation details (including hotel star ratings exactly as provided in the hotels_info) with check-in/check-out times
4. Creates a day-by-day itinerary that:
   ...
   - **IMPORTANT: Verify and mention the opening hours/work timings of each place or attraction**
   - **Ensure all suggested places are open and active during the planned visit dates**
   - **Check for any holidays or closures that might affect the planned activities**
   ...
   - Includes hotel star ratings exactly as shown in the hotels information
   - Includes Image links in the itinerary for the sights and hotels
5. Ends with practical tips specific to the destination (local transportation, weather considerations, cultural notes, local holidays)
