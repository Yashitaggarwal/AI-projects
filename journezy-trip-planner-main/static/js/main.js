...
function setupTravellerLogic() {
    ...
    function updateFriendlyOptions() {
        ...
        // ALWAYS enable all containers - NO restrictions
        ...
        // Smart defaults: auto-check boxes based on passenger types
        // BOTH can be selected - NO mutual exclusion!
        if (totalChildren > 0 && totalSeniors > 0) {
            // Multi-generational trip: SELECT BOTH!
            console.log('[SMART-DEFAULTS] Auto-selecting BOTH toddler AND senior friendly (multi-generational)');
            toddlerFriendlyCheckbox.checked = true;
            seniorFriendlyCheckbox.checked = true;
            // NO flight preference auto-selection - user decides
        } else if (totalChildren > 0) {
            // Only children: auto-select toddler-friendly
            console.log('[SMART-DEFAULTS] Auto-selecting toddler-friendly (children only)');
            toddlerFriendlyCheckbox.checked = true;
            seniorFriendlyCheckbox.checked = false;
            // NO flight preference auto-selection
        } else if (totalSeniors > 0) {
            // Only seniors: auto-select senior-friendly
            console.log('[SMART-DEFAULTS] Auto-selecting senior-friendly (seniors only)');
            toddlerFriendlyCheckbox.checked = false;
            seniorFriendlyCheckbox.checked = true;
            // NO flight preference auto-selection
        } else {
            // No children or seniors: uncheck both
            console.log('[SMART-DEFAULTS] No children or seniors');
            toddlerFriendlyCheckbox.checked = false;
            seniorFriendlyCheckbox.checked = false;
        }
        // Flight checkboxes stay as user left them - NO auto-selection
    }
    ...
    // NO mutual exclusion - users can select any combination they want!
    console.log('[PREFERENCES] All checkboxes are independent - no mutual exclusion');
